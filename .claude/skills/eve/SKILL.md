---
name: eve
description: "Widgets, App Intents, Live Activities y Shortcuts. WidgetKit, Dynamic Island, StandBy y Siri. Úsalo cuando la app deba vivir fuera de su propia pantalla. AppleAppLabUI no se importa en extensiones."
---
